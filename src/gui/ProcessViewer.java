...
/**
 * GUI for the process viewer. This allows the user to view the list of utensils and steps in a recipe. 
 * 
 * @version 3/29/23
...
//	}
	 ...
	 */
	private JScrollPane setUpUtensils(List<Utensil> utensils) {
	 ...
	 */
	private JScrollPane setUpSteps(List<Step> steps) {
		JTextArea textArea = new JTextArea();
		for(Step item: steps) {
			textArea.append(String.format("- %s\n", item.getDetails()));
		}
